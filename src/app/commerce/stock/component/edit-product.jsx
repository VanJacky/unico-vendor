        ...
        <form>
            <div className="space-y-12">
                <div className="border-b border-gray-900/10 pb-12">
                    ...
                    <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div className="sm:col-span-4">
                            ...
                            <p className="mt-3 text-sm leading-6 text-gray-600">Write a few sentences about this
                                product.</p>
                        </div>
                        ...
                        <div className="sm:col-span-4">
                            ...
                            <div
                                ...
                                <div className="text-center">
                                    ...
                                    <p className="text-xs leading-5 text-gray-600">MP4  up to 200MB</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="border-b border-gray-900/10 pb-12">
                    ...
                    <p className="mt-1 text-sm leading-6 text-gray-600">Add and manage product specifications, images, stock, and pricing information.</p>
