                ...
                <Table className="mt-4 [--gutter:theme(spacing.6)] lg:[--gutter:theme(spacing.10)]">
                    <TableHead>
                        <TableRow>
                            ...
                            <TableHeader>Discount Amount</TableHeader>
                            <TableHeader>Usage Rules</TableHeader>
                            <TableHeader>Applicable Scope</TableHeader>
                            <TableHeader>Claimed Quantity</TableHeader>
                            <TableHeader>Used Quantity</TableHeader>
                        ...
                        {coupons.map((coupon) => (
                            <React.Fragment key={coupon.couponName}>
                                ...
                                >
                                    ...
                                    <TableCell>{coupon.usageRules}</TableCell>
                                    <TableCell>{coupon.applicableScope}</TableCell>
                                    <TableCell>{coupon.claimedQuantity}</TableCell>
                                    <TableCell>{coupon.usedQuantity}</TableCell>
                                    <TableCell>
                                        <Badge
                                            className="max-sm:hidden"
                                            color={coupon.status === '进行中' ? 'lime' : 'zinc'}
                                        >
                                            {coupon.status}
                                        </Badge>
                                    </TableCell>
                                    <TableCell className="text-zinc-500">{coupon.creationTime}</TableCell>
                                    <TableCell>
